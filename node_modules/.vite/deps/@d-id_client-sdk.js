...
var se = ((e) => (e.TRIAL = "trial", e.BASIC = "basic", e.ENTERPRISE = "enterprise", e.LITE = "lite", e.ADVANCED = "advanced", e))(se || {});
var oe = ((e) => (e.TRIAL = "deid-trial", e.PRO = "deid-pro", e.ENTERPRISE = "deid-enterprise", e.LITE = "deid-lite", e.ADVANCED = "deid-advanced", e.BUILD = "deid-api-build", e.LAUNCH = "deid-api-launch", e.SCALE = "deid-api-scale", e))(oe || {});
var ce = ((e) => (e.Created = "created", e.Started = "started", e.Done = "done", e.Error = "error", e.Rejected = "rejected", e.Ready = "ready", e))(ce || {});
var de = ((e) => (e.Unrated = "Unrated", e.Positive = "Positive", e.Negative = "Negative", e))(de || {});
var I = ((e) => (e.Functional = "Functional", e.TextOnly = "TextOnly", e.Maintenance = "Maintenance", e.Playground = "Playground", e.DirectPlayback = "DirectPlayback", e))(I || {});
var B = ((e) => (e.Embed = "embed", e.Query = "query", e.Partial = "partial", e.Answer = "answer", e.Complete = "done", e))(B || {});
var le = ((e) => (e.KnowledgeProcessing = "knowledge/processing", e.KnowledgeIndexing = "knowledge/indexing", e.KnowledgeFailed = "knowledge/error", e.KnowledgeDone = "knowledge/done", e))(le || {});
var me = ((e) => (e.Knowledge = "knowledge", e.Document = "document", e.Record = "record", e))(me || {});
var ue = ((e) => (e.Pdf = "pdf", e.Text = "text", e.Html = "html", e.Word = "word", e.Json = "json", e.Markdown = "markdown", e.Csv = "csv", e.Excel = "excel", e.Powerpoint = "powerpoint", e.Archive = "archive", e.Image = "image", e.Audio = "audio", e.Video = "video", e))(ue || {});
var Q = ((e) => (e.Clip = "clip", e.Talk = "talk", e))(Q || {});
var fe = (e) => {
  switch (e) {
    case "clip":
      return "clip";
...
var j = ((e) => (e.Start = "START", e.Stop = "STOP", e))(j || {});
var W = ((e) => (e.ChatAnswer = "chat/answer", e.ChatPartial = "chat/partial", e.StreamDone = "stream/done", e.StreamStarted = "stream/started", e.StreamFailed = "stream/error", e.StreamReady = "stream/ready", e.StreamCreated = "stream/created", e.StreamVideoCreated = "stream-video/started", e.StreamVideoDone = "stream-video/done", e.StreamVideoError = "stream-video/error", e.StreamVideoRejected = "stream-video/rejected", e))(W || {});
var D = ((e) => (e.New = "new", e.Fail = "fail", e.Connected = "connected", e.Connecting = "connecting", e.Closed = "closed", e.Completed = "completed", e.Disconnected = "disconnected", e))(D || {});
var ge = ((e) => (e.Amazon = "amazon", e.Microsoft = "microsoft", e.Afflorithmics = "afflorithmics", e.Elevenlabs = "elevenlabs", e))(ge || {});
var he = ((e) => (e.Public = "public", e.Premium = "premium", e.Private = "private", e))(he || {});
var H = "https://api.d-id.com";
var we = "wss://notifications.d-id.com";
var pe = "79f81a83a67430be2bc0fd61042b8faa";
...
var re = false;
var z = (e, t) => re && console.log(e, t);
var $e = (window.RTCPeerConnection || window.webkitRTCPeerConnection || window.mozRTCPeerConnection).bind(window);
function Y(e) {
  switch (e) {
    case "connected":
      return D.Connected;
...
function Te(e, t, s = false, a, n, i = false) {
  ...
  return setInterval(async () => {
    ...
    if (f)
      h = 0, d || (t == null || t(j.Start), i && y >= k && !a() && n(), l = m[m.length - 1], m = [], y++, d = true), m.push(M);
    else if (d && (h++, h >= o)) {
      const R = Pe(m, 100, l);
      t == null || t(j.Stop, R), !i && !a() && n(), d = false;
    }
  }, 100);
}
async function ze(e, t, {
  ...
  const c = () => R, g = () => {
    var u;
    R = true, (u = a.onConnectionStateChange) == null || u.call(a, D.Connected);
...
var J = (e) => e.type === "clip" && e.presenter_id.startsWith("v2_") ? "clip_v2" : e.type;
var U = {};
function Le(e) {
  var i, r, o, m, l, h;
...
async function Ue(e, t) {
  ...
  async function y(c) {
    ...
    p && p.id !== ((F = n.chat) == null ? void 0 : F.id) && ((P = (T = t.callbacks).onNewChat) == null || P.call(T, p.id)), n.streamingManager = u, n.socketManager = S, n.chat = p, a = false, w((p == null ? void 0 : p.chat_mode) ?? t.mode ?? I.Functional);
  }
  async function C() {
    var c, g, v, S;
  ...
  return {
    ...
    async connect() {
      var c;
      await y(true), d.track("agent-chat", {
        event: "connect",
    ...
    async reconnect() {
      var c;
      await C(), await y(false), d.track("agent-chat", {
        event: "reconnect",
        chatId: (c = n.chat) == null ? void 0 : c.id,
        agentId: l.id,
        mode: n.chatMode
    ...
    async chat(c) {
      ...
      try {
        ...
        const F = (P) => {
          ...
          return await C(), await y(false), F(n.chat.id);
        });
